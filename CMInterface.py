...
#Globals...
operatorIndex = -1          #index into this tuple: ("+","-","*","/","%","**","//")
numberOfQuestionSets = 1    #user chosen number of question sets to display.
accuracyLevel = 0           #default level of accuract when rounding.
...
def menu2operands():
    ...
    menuText = """
    Carry out basic calculations with two operands
    ==============================================
    ...
    """ 
    print(menuText)
    calcChoice = input("Please choose 1, 2, 3, 4 [or 0 for previous menu]: ")
...
def menuRounding():
    ...
    menuText = """
    Practice rounding numbers to a given number of decimal places
    =============================================================
    ...
    print(menuText)
    roundingChoice = input("Please choose 1, 2, 3, 4 [or 0 for previous menu]: ")
